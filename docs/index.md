...
The legacy `IVectorDatabase` / `IVectorCollection` interfaces have been removed in favor of MEVA. See the [migration guide](guides/migration-to-meva.md) for detailed before/after examples.
